...
class TestSonosToolsSystem(unittest.TestCase):
    ...
    def test_Db_roundtrip(self):
        ...
        db.remove(client, "XXX_TEST_ABC")
        self.assertIsInstance(db.insert(client, "XXX_TEST_ABC", b"ABCD"), pymongo.results.InsertOneResult)
    ...
    def test_service(self):
        ...
        db.remove(client, expectedAudioConfigHash)
        ...
        #db.remove(client, actualAudioConfigHash)
